    ...
    >
      <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
        ...
        <div className="flex flex-col items-center gap-1 text-center">
          <p>© {new Date().getFullYear()} <a href="/" className="hover:text-slate-700 dark:hover:text-slate-200 transition-colors font-medium">AI Resume Analyzer</a>. All rights reserved.</p>
        </div>
      </div>
    </motion.footer>
  )
